...
export default function Step3Rules({
  backlogDays, setBacklogDays, isPro, setUpgradeVisible,
  requirePhoto, setRequirePhoto, teamsMode, setTeamsMode,
  isPublic, setIsPublic, renewalType, setRenewalType,
  maxParticipants, setMaxParticipants, tieBreak, setTieBreak,
}: Step3RulesProps) {
  return (
    <>
