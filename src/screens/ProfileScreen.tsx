...
const heat = StyleSheet.create({
  ...
  dayLabel: { height: 14, fontSize: 9, fontWeight: '600', fontFamily: F.medium, color: C.muted, textAlignVertical: 'center' },
...
const s = StyleSheet.create({
  ...
  avatarText: { fontSize: 32, fontWeight: '900', fontFamily: F.disp, color: C.primary },
  ...
  fullName: { fontSize: 26, fontWeight: '700', fontFamily: F.bold, color: C.text, letterSpacing: -0.3 },
  username: { fontSize: 14, fontWeight: '500', fontFamily: F.medium, color: C.muted },
  ...
  tierBadgeText: { fontSize: 11, fontWeight: '700', fontFamily: F.bold, color: '#FBBF24', letterSpacing: 0.5 },
  ...
  proBadgeText: { fontSize: 11, fontWeight: '800', fontFamily: F.disp, color: C.primary, letterSpacing: 1 },
  ...
  upgradeBtnText: { fontSize: 12, fontWeight: '700', fontFamily: F.bold, color: C.primary },
  editProfileBtn: { borderWidth: 1, borderColor: C.border, borderRadius: 20, paddingHorizontal: 24, paddingVertical: 8, marginTop: 4 },
  editProfileBtnText: { fontSize: 13, fontWeight: '600', fontFamily: F.medium, color: C.text },

  sectionLabel: { fontSize: 10, fontWeight: '700', fontFamily: F.bold, color: C.muted, letterSpacing: 1.4, textTransform: 'uppercase', marginBottom: 11 },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 11 },
  editLink: { color: C.primary, fontSize: 13, fontWeight: '700', fontFamily: F.bold },

  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginBottom: 24 },
  statCard: { flex: 1, backgroundColor: C.card, borderRadius: 14, borderWidth: 1, borderColor: C.border, padding: 14 },
  statIcon: { fontSize: 18, marginBottom: 6 },
  statValue: { fontSize: 24, fontWeight: '900', fontFamily: F.disp, color: C.text, letterSpacing: -0.5 },
  statLabel: { fontSize: 11, color: C.muted, fontWeight: '600', fontFamily: F.medium, marginTop: 2 },
  ...
  streakNum: { fontSize: 32, fontWeight: '900', fontFamily: F.disp, color: C.primary },
  streakLabel: { fontSize: 12, color: C.muted, fontWeight: '600', fontFamily: F.medium },
  ...
  freezeBtnText: { fontSize: 13, fontWeight: '700', fontFamily: F.bold, color: '#22C55E' },
  ...
  syncTitle: { fontSize: 13, fontWeight: '700', fontFamily: F.bold, color: C.success },
  ...
  syncNowText: { color: '#000', fontWeight: '800', fontFamily: F.disp, fontSize: 12 },
  ...
  warningSub: { fontSize: 12, color: C.muted, marginTop: 2, fontWeight: '600', fontFamily: F.medium },
  ...
  connectBannerTitle: { fontSize: 14, fontWeight: '700', fontFamily: F.bold, color: C.text },
  ...
  challengeName: { fontSize: 14, fontWeight: '700', fontFamily: F.bold, color: C.text, marginBottom: 2 },
  challengeMeta: { fontSize: 12, color: C.muted },
  challengeScore: { fontSize: 16, fontWeight: '800', fontFamily: F.disp, color: C.primary },
  ...
  achievementTitle: { fontSize: 13, fontWeight: '800', fontFamily: F.disp, color: C.text, textAlign: 'center' },
  ...
  notifLabel: { fontSize: 14, fontWeight: '700', fontFamily: F.bold, color: C.text, marginBottom: 2 },
  ...
  signOutBtnText: { color: C.error, fontSize: 15, fontWeight: '700', fontFamily: F.bold },
  legalRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 8, marginTop: 16, marginBottom: 8 },
  legalLink: { color: C.muted, fontSize: 11, fontWeight: '600', fontFamily: F.medium },
